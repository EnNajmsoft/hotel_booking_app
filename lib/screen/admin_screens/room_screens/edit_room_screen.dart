...
import '../../../controller/admin/rooms/edit_controller.dart';
...
class EditRoomScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    RoomEditAdminControllerImp controller =
        Get.put(RoomEditAdminControllerImp());

    return Scaffold(
      appBar: AppBar(
        title: Text("Add Notes"),
      ),
      body: GetBuilder<RoomEditAdminControllerImp>(
            ...
            child: ListView(
              children: [
                CustomTextForm(
                  ...
                  hinttext: controller.roomnamear.text,
                ...
                CustomTextForm(
                  ...
                  hinttext: controller.roomname.text,
                ...
                CustomTextForm(
                  ...
                  hinttext: controller.roomprice.text,
                  iconData: Icons.email_outlined,
                  labeltext: "السعر",
                ),
                CustomTextForm(
                  ...
                  hinttext: controller.roomdescont.text,
                  iconData: Icons.email_outlined,
                  labeltext: "التخفيض",
                ),
                CustomTextForm(
                  ...
                  hinttext: controller.roomnote.text,
                  iconData: Icons.email_outlined,
                  labeltext: "ملاحظه",
                ),
